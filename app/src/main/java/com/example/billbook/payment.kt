...
class payment : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val data = Transaction_data(name.toString(),"- "+price.toString(),product.toString())
        ...
        pay.setOnClickListener{
            ...
            wait.playAnimation()
            FirebaseDatabase.getInstance().getReference("transaction").push().setValue(data).addOnCompleteListener{ task ->
                if(task.isSuccessful){
                    ...
                    Snackbar.make(this.findViewById(android.R.id.content),"transaction unsuccessful",Snackbar.LENGTH_SHORT).show()
                }
            }
        }
    }
